  ...
  return <main>
    ...
    <section className="impactHero" id="top">
      ...
      <div className="heroReel" aria-label="Featured website concept previews">
        ...
        <a className="reelCard reelFitness" href="/demo/fitness"><img src="/concept-fitness.png" alt="Fitness coaching platform concept"/><div className="reelChrome"><i/><i/><i/><span>forge.system</span></div><div className="reelCopy"><small>02 / FITNESS PLATFORM</small><b>OUTWORK<br/>YESTERDAY.</b><span>VIEW BUILD ↗</span></div></a>
        <a className="reelCard reelLex" href="https://lexautoworks.com/" target="_blank" rel="noreferrer"><div className="reelChrome"><i/><i/><i/><span>lexautoworks.com</span></div><div className="reelLexInner"><small>LIVE CLIENT PROJECT</small><b>LEX<br/>AUTO WORK</b><p>TOYOTA + LEXUS SPECIALIST</p><div><span>F SPORT</span><span>2UR V8</span><span>HYBRID</span></div></div><label>VIEW LIVE WEBSITE ↗</label></a>
        <a className="reelCard reelRestaurant" href="/demo/restaurant"><img src="/concept-restaurant.png" alt="Premium restaurant website concept"/><div className="reelChrome"><i/><i/><i/><span>kodo.openfire</span></div><div className="reelCopy"><small>03 / HOSPITALITY</small><b>CONTROL<br/>THE FLAME.</b><span>RESERVE A TABLE ↗</span></div></a>
        <a className="reelCard reelCommerce" href="/demo/ecommerce"><img src="/concept-commerce.png" alt="Technology ecommerce website concept"/><div className="reelChrome"><i/><i/><i/><span>vector.audio</span></div><div className="reelCopy right"><small>04 / ECOMMERCE</small><b>PURE<br/>SIGNAL.</b><span>SHOP THE SYSTEM ↗</span></div></a>
        <a className="reelCard reelMedical" href="#range"><img src="/concept-medical.png" alt="Advanced healthcare website concept"/><div className="reelChrome"><i/><i/><i/><span>nexus.health</span></div><div className="reelCopy"><small>05 / HEALTHCARE</small><b>CARE,<br/>ENGINEERED.</b><span>BOOK CONSULTATION ↗</span></div></a>
      </div>
      <div className="wallTicker"><span>STRATEGY</span><i>✦</i><span>DESIGN</span><i>✦</i><span>FRONTEND</span><i>✦</i><span>BACKEND</span><i>✦</i><span>LAUNCH</span></div>
    </section>

    <section className="engineeringProof"><div className="shell"><div className="proofHeader"><p>ENGINEERING CAPABILITY / 2026</p><span>ALL SYSTEMS OPERATIONAL <i/></span></div><div className="proofGrid"><article><small>01 / EXPERIENCE</small><b>Interfaces that don&apos;t<br/>look templated.</b><p>Custom art direction, responsive systems, motion, interaction, and accessibility engineered around the brand.</p></article><article><small>02 / ARCHITECTURE</small><b>Real systems behind<br/>the visuals.</b><p>Authentication, databases, dashboards, APIs, payments, invoices, automation, and deployment—not just a landing page.</p></article><article><small>03 / OWNERSHIP</small><b>Source code you<br/>actually control.</b><p>Portable builds prepared for GitHub, Render, Supabase, Stripe, and the next phase of your business.</p></article></div></div></section>

    <section className="demoLab" id="range"><div className="shell demoLabHead"><p className="kicker">Interactive concept lab</p><h2>Click in.<br/>Browse around.</h2><p>These are not static mockups. Open a concept to navigate pages, explore products or services, view details, and try working interactions.</p></div><div className="shell demoLabGrid">
      <a href="/demo/real-estate"><span>01 / REAL ESTATE</span><h3>Vanta Properties</h3><p>Browse luxury residences, open property details, and request a private tour.</p><b>LAUNCH DEMO ↗</b></a>
      <a href="/demo/fitness"><span>02 / FITNESS</span><h3>Forge Coaching</h3><p>Explore training programs, coaching methodology, results, and assessment flow.</p><b>LAUNCH DEMO ↗</b></a>
      <a href="/demo/restaurant"><span>03 / HOSPITALITY</span><h3>Kodo Open Fire</h3><p>Browse the menu, discover the dining experience, and test a reservation request.</p><b>LAUNCH DEMO ↗</b></a>
      <a href="/demo/ecommerce"><span>04 / ECOMMERCE</span><h3>Vector Audio</h3><p>Explore products, open specifications, add items, and interact with a demo bag.</p><b>LAUNCH DEMO ↗</b></a>
    </div></section>
